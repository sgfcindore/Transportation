...
async function calculateStats() {
  const stats = {
    ...
    parkingCount: 0     // NEW: Completed parking count
  };
  ...
  try {
    ...
    stats.parkingIncome = parkingIncome.completed;
    stats.parkingCount = parkingIncome.completedCount;
    stats.totalIncome += stats.parkingIncome;
    
    console.log(`💰 Parking: ₹${stats.parkingIncome.toLocaleString('en-IN')} from ${stats.parkingCount} vehicles`);
